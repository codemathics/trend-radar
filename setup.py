#!/usr/bin/env python3
"""
trendvane local installer (git-clone path).
...
people who cloned the repo and don't want to use the skills cli. it:
  ...
  3. creates the user data dir (~/.claude/trendvane) so config survives updates

after it runs, open claude code and type /trendvane.
"""
...
if sys.version_info < (3, 10):
    print(f"\n  python {sys.version.split()[0]} found, but trendvane needs 3.10+")
...
seed_src = SKILLS_SRC / "trendvane" / "memory"
