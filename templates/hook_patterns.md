...
Hooks are tagged by archetype + niche affinity. When generating, the engine picks the archetype best matched to the trend AND least recently used by Clement.
